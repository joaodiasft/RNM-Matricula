...
export const ACCESS_SYSTEMS: {
  ...
  { key: "sistema", label: "Sistema (aluno)", hint: "Login é o número de matrícula" },
  { key: "responsavel", label: "Responsável", hint: "Login do responsável principal" },
...
export function buildAccessMessage(input: {
  ...
  return [
    ...
    ``,
    `🔐 *Sistema (aluno)*`,
    `Login: ${a.sistemaLogin}`,
    `Senha: ${a.sistemaPassword}`,
    ``,
    `🔐 *Responsável*`,
    `Login: ${a.responsavelLogin}`,
